...
const Banner = () => {
  return (
    <div className="mb-20">
      <div className="flex justify-between gap-6 mt-20 w-[1440px] mx-auto">
        <div className="card w-190 bg-[#643FDD] shadow-xl bg-img">
        ...
        <div className="card w-190 bg-[#36b45a] shadow-xl image-full">
